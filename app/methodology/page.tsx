  ...
  return (
    <main className="shell space-y-6 py-8">
      ...
      {[
        ...
        ["Project and medical disclaimer", "This is an independent software project for data visualization and portfolio purposes. It is not affiliated with WHO, CDC, ECDC, or any health agency. It is not medical advice, not a government or public-health source, and not guaranteed live surveillance. Do not use it for medical, travel, or public-health decision-making; consult official public-health agencies and medical professionals."]
      ].map(([title, body]) => (
